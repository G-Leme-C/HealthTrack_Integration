...
<html>
    <head>
        <title>Health Track - AlimentaÃ§ão</title>
        <meta charset="utf-8">
        ...
        <section class="container-fluid">
            <div class="row mb-5">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="mt-2">
                            <img src="img/user_purple.png" alt="imagem do usuÃ¡rio" class="icon-size-6 p-2 m-1 float-left" >
                            <a class="btn float-right" ><img src="img/pencil-edit-button_purple.png" alt="imagem do usuÃ¡rio" class="icon-size-2"></a>
